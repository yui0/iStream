...
CFLAGS += -Os -DLINUX -D_GNU_SOURCE -Wall
# CFLAGS += -g
#CFLAGS +=  -DDEBUG
...
input_screen.so: mjpg_streamer.h utils.h
	make -C plugins/input_screen all
	cp plugins/input_screen/input_screen.so .
